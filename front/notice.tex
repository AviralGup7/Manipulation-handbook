...
(\texttt{B1}, \texttt{B2}, \dots) at entry level, with full dossier detail in the companion Source Dossiers volume,
...
%% GENERATED FILE, DO NOT EDIT -- emitted from registry/books.yaml.
\input{registry/compiled/sources}

\vspace{4pt}
The register is kept append-only: sources are added, never renumbered
or removed, so a citation printed in one edition remains valid in every
later one.
...
name is a technique you cannot refuse. Each entry therefore answers, in
order: what the phenomenon is, why it works, when it works, how it appears
in a real interaction, what signals success or resistance, how it fails,
and how it is recognised and resisted. Recognition and refusal carry as
much weight as execution; the handbook is usable defensively first.
...
reader can recognise the pattern being used against them; the failure
section records the legal and practical blowback. Use this book on yourself and
in your own defence.
...
entry is not padded to compensate.
