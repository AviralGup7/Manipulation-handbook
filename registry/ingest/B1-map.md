...
* First-person narrative about the author's teacher and the author's own losses.
  The lessons survive; the stories do not.
* Repeated restatement of the same point in three registers.
* Gendered framing of examples, which is period artefact and not mechanism.
* Justification of the book's own premise beyond the first chapter.
...
| Tactic 8 — avoiding being taken in financial dealings | `T-05-02`; `T-25-01` | partly merged / **planned** |
| Tactic 9 — manipulating a person's thinking | `T-16-02` | **planned** |
| Tactic 10 — win ninety-five percent of your arguments | `T-08-02`; `T-16-01`, `T-16-03` | partly merged / **planned** |
| Tactic 11 — manipulate a person against his will; the unargue technique | `T-16-04` | **planned** |
| Tactic 12 — a little pressure has its place, but seldom | `T-19-01`, `T-20-01` | **planned** |
