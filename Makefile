...
.PHONY: all check guard index pdf verify corpus clean help selftest \
...
# ---------------------------------------------------------------------
# Typesetting. Works with latexmk, or plain pdflatex, or tells you what
# to install. Never silently does nothing.
# ---------------------------------------------------------------------
pdf: index
