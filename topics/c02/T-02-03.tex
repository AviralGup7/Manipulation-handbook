...
\begin{failure}
Patience requires that you can afford to wait, and the source notes that the person with high fixed costs cannot. Waiting is a lever only for the party with the smaller exposure, which means the honest first move is often to reduce your exposure before entering the exchange rather than to sit tight inside it. Patience also decays into drift if there is no defined trigger for acting.
\end{failure}
