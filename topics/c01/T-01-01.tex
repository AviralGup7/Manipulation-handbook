...
\begin{failure}
The premise is a posture, and postures have a cost. Held too tightly it produces a person who cannot accept help, cannot be surprised by generosity, and reads every kindness as a setup --- which is itself a form of being controlled, just by fear. The sources acknowledge the trade. The usable version is situational: verify hard where money, commitment or reputation is at stake, and let the default rule stand where it does not.
\end{failure}
