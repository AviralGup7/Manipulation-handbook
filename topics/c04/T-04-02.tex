...
\begin{mechanism}
The obligation works because refusing to repay feels like a statement about your character rather than about the transaction. That is what makes it leverage: the cost of refusing is paid in self-image, not in money. It is also why the lever is unreliable --- the account has no agreed balance, so the debtor can always conclude that the debt has been settled, or was never incurred, or was discharged by the resentment the giving produced. What makes it strong in the moment is that the enforcement is public: the person who takes a benefit and returns nothing is marked, and the marking is visible, so the cost of refusing is paid in front of an audience rather than in private. What makes it weak afterwards is the same undefined balance --- and an unsettled account is unpleasant enough to hold that relieving it becomes a motive in its own right. Both sources therefore treat gratitude as a poor instrument in either direction: weak to collect on, and expensive to owe.
\end{mechanism}
