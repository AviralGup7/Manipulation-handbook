...
\end{counters}
\begin{cost}
It counsels caution to the point of paralysis if taken literally, since no counterpart's response type is fully observable in advance. It also has a moral cost: a policy of never offending the dangerous and freely offending the safe is a policy of predation on the people least able to defend themselves, and both sources eventually price that. The usable version is a screening rule --- gather history, keep costs low, settle early --- not a targeting rule.
\end{cost}
